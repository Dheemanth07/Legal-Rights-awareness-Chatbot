...
const RetryIcon = () => (
    ...
    >
        <path
            ...
            d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 11.667 0l3.181-3.183m-4.991-2.691v4.992"
        />
    </svg>
);
...
const Message: React.FC<MessageProps> = ({
    ...
    const handlePlayAudio = async () => {
        ...
        if (audioData) {
            try {
                ...
                // Ensure context is running (needed for some browsers like Safari)
    ...
    const renderContent = () => {
        ...
        const finalHtml = message.isLoading
            ? baseHtml +
              '<span class="w-2.5 h-5 bg-current animate-pulse inline-block ml-1"></span>'
            : baseHtml;
    ...
    return (
        <div className={`${containerClasses} animate-in`}>
            ...
            <div className="flex flex-col">
                <div
                    className={`max-w-md md:max-w-lg lg:max-w-2xl px-4 py-3 rounded-2xl shadow-md ${bubbleClasses}`}
                >
                    {message.image && (
                        <img
                            src={message.image}
